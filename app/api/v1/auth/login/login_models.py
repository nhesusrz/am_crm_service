...
class TokenResponseModel(BaseModel):
    ...
    This model is used to encapsulate the details of an authentication response,
    which includes the access token and its type.

    Attributes
    ----------
        access_token (str): The JWT access token that can be used to access protected
        resources.
...
class RefreshTokenRequest(BaseModel):
    ...
    This model is used to encapsulate the details required to request a new access
